...
builtAreas <- sf::read_sf(dsn = "data/lagos-built-up-areas/built-up-areas.geojson")
dumps <- sf::read_sf(dsn = "data/lagos-dump-sites/dump-sites.geojson")
